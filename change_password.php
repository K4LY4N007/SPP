              ...
              if(isset($_POST['changepassword_submit'])){
                ...
                if($newpassword == $confirm_password){
                  if(strcasecmp($oldpassword,$password)==0){
                      $sql1 = "UPDATE SPP.admin SET password='$newpassword' WHERE email='$email'";
                      if ($conn->query($sql1) === TRUE) {
                        echo "<script type='text/javascript'>alert('password change successful !!');location.href = 'dashboard.php';</script>";
                      } else {

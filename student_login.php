...
<html lang="en">
  <head>
    ...
    <title>Student Login · Marks Prediction </title>
    ...
    <div class="main-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      ...
      <img class="mb-4" src="KSSEM_Logo.png" alt="Body Vignyan" width="640" height="117">
        <form class="form-signin" method="POST">
          ...
          <input type="text" id="inputEmail" name="usn" class="form-control" placeholder="University seat number" required>
          ...
          <p>Not a Student ? &nbsp;<span ><a href="home_page.php" class="link">Back to home page</a></span> </p>
        </form>
      </main>
      <?php
        if($_SERVER["REQUEST_METHOD"] == "POST"){
          ...
          $Password=$_POST['password'];
            ...
            $student_password=$row['user_password'];
            if(strcasecmp($student_password,$Password)==0){
